...
@Composable
fun ArtistDetailScreen(navController: NavController, artistName: String) {
    ...
    LaunchedEffect(artistName) {
        CloudriveApp.locator.trackRepository.observeByArtist(artistName).collectLatest { tracks = it }
    }
            ...
            when {
                ...
                current.isEmpty() -> EmptyState(
                    ...
                    Row(
                        ...
                        Button(onClick = {
                            CloudriveApp.locator.playerController.playQueue(current, 0, sourceLabel = "Artist: $artistName")
                        }) {
                        ...
                        items(current, key = { it.fileId }) { track ->
                            TrackRow(
                                ...
                                onClick = {
                                    ...
                                    CloudriveApp.locator.playerController.playQueue(current, index, sourceLabel = "Artist: $artistName")
                                },
